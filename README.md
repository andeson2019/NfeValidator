...
As decisões técnicas para implementação desse projeto foram pautadas pela escalabilidade, testabilidade, desacoplamento (fazendo uso de injeção de dependências) e em boas práticas de arquitetura de projetos e do ecossistema .Net. 
